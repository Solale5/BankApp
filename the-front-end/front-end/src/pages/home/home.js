...
// for formatting form in modal popup
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              <Form>
                ...
                <Form.Group as={Row} className="mb-3" controlId="checkingAccNum">
                  <Col sm={10}>
                    <Form.Control  type="text" placeholder="Account Number" />
                  </Col>
                </Form.Group>

                <Form.Group as={Row} className="mb-3" controlId="checkingRoutNum">
                  <Col sm={10}>
                    <Form.Control  type="text" placeholder="Routing Number" />
                  </Col>
                </Form.Group>

                <Form.Group as={Row} className="mb-3" controlId="checkingAmount">
